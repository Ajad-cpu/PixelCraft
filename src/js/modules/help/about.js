	...
	about() {
		...
		var settings = {
			...
			params: [
				...
				{title: "Name:", html: '<span class="about-name">PixelCraft</span>'},
				{title: "Version:", value: VERSION},
				{title: "Description:", value: "Online image editor."},
				{title: "Author:", value: 'ViliusL'},
				{title: "Email:", html: '<a href="mailto:' + email + '">' + email + '</a>'},
				{title: "GitHub:", html: '<a href="https://github.com/viliusle/PixelCraft">https://github.com/viliusle/PixelCraft</a>'},
				{title: "Website:", html: '<a href="https://viliusle.github.io/PixelCraft/">https://viliusle.github.io/PixelCraft/</a>'},
			],
		};
